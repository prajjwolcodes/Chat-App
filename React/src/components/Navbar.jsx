            ...
            <nav className="bg-white border-gray-200 dark:bg-gray-900">
                <div className="flex flex-wrap items-center justify-between ">
                    <a href="" className="flex items-center space-x-1">
                        ...
                        <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Connect Us</span>
                    </a>
                    <div className="flex items-center">
                        {isUserLoggedIn ?
                            <>
                                <button>
                                    <a onClick={handleLogout} className="block px-7 py-5 text-md text-black hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Sign out</a>
                                </button>
                                <button type="button" className="flex text-md bg-gray-800 rounded-full mr-7 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" >
                                    <img className="w-8 h-8 rounded-full" src={isUserLoggedIn.profilePic} alt="user photo" />
                                </button>
                            </>
                            :
                            <>
